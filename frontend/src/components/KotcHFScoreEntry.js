...
function KotcHFScoreEntry({ selectedIndex }) {
    ...
    useEffect(() => {
        const fetchFixtures = async () => {
            try {
                const response = await fetch(`http://backend-dev22.ap-southeast-1.elasticbeanstalk.com/fixtures/round/${selectedIndex + 1}`);
        ...
        const fetchSubmittedPoints = async (fixturesData) => {
            try {
                const response = await fetch(`http://backend-dev22.ap-southeast-1.elasticbeanstalk.com/fixtures/round/${selectedIndex + 1}/points`);
                const data = await response.json();
        ...
        const fetchAcceptingInput = async () => {
            try {
                const response = await fetch(`http://backend-dev22.ap-southeast-1.elasticbeanstalk.com/fixtures/round/${selectedIndex + 1}/acceptingInput`);
                const data = await response.json();
    ...
    const submitPointsForTeamInRound = async (teamId) => {
        ...
        try {
            const response = await fetch(`http://backend-dev22.ap-southeast-1.elasticbeanstalk.com/fixtures/round/${selectedIndex + 1}/team/${teamId}`, {
                method: 'PUT',
                headers: {
